...
const App: React.FC = () => {
  ...
  return (
    <div className="relative h-full font-sans text-ios-label bg-ios-bg selection:bg-mag-gold selection:text-white">
      ...
      <main
        className="max-w-xl mx-auto px-6 h-full overflow-y-auto overscroll-contain"
        style={{
