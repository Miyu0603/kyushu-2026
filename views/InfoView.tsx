      ...
      <section>
        ...
        <div className="bg-ios-card border border-ios-separator rounded-ios-lg overflow-hidden shadow-ios-card">
          ...
          {EMERGENCY_CONTACTS[2] && (
            <a href={`tel:${EMERGENCY_CONTACTS[2].number}`} className="block px-5 py-4 active:bg-ios-fill-3">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-[14px] font-semibold text-ios-label">{EMERGENCY_CONTACTS[2].title}</div>
                  {EMERGENCY_CONTACTS[2].note && <div className="text-[11px] text-ios-label-2 mt-0.5">{EMERGENCY_CONTACTS[2].note}</div>}
                </div>
                <div className="text-[20px] font-mono font-bold text-ios-red">{EMERGENCY_CONTACTS[2].number}</div>
              </div>
            </a>
          )}
        </div>
